...
from query/query import Queryprocess
...
if __name__ == "__main__":
    ...
    multi_step_model.add(tf.keras.layers.LSTM(num_neurons_1, return_sequences=True, input_shape=x_train_multi.shape[1:]))
    multi_step_model.add(tf.keras.layers.LSTM(num_neurons_2, activation='relu'))
    ...
    plot_train_history(multi_step_history, 'Multi-Step Training and validation loss', num_neurons_1, num_neurons_2)
